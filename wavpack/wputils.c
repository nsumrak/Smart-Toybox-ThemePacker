...
static uint32_t WavpackGetNumSamples (WavpackContext *wpc)
{
...
static uint32_t WavpackGetSampleIndex (WavpackContext *wpc)
{
    if (wpc)
...
static uint32_t WavpackGetSampleRate (WavpackContext *wpc)
{
